...
echo -----------------------------
echo.
echo Generate a random 16 digit password
echo The password will consist of numbers, uppercase letters and lowercase letters
echo.
...
echo %password%
echo.
echo Your password has been saved to your clipboard and desktop for later use.

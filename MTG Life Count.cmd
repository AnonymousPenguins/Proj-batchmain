...
set tod-date=%DATE:~10,4%%DATE:~4,2%%DATE:~7,2%
cls
...
echo ------------------------
echo Your licensed expired on (YYYYDDMM) %exp%
...
cls
echo Opening End User License Agreement and Privacy Policy
echo Close the Help window to continue
hh http://dkincorporated.ml/mtg-lifecounter-eula/
goto menu
